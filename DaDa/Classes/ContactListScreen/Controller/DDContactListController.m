...
#import "TMContactListView.h"
#import "SWRevealViewController.h"
#import "TMContactListController.h"


@interface TMContactListController ()<TMContactListViewDeleage>
{
    TMContactListView *_messageView;
}
@end

@implementation TMContactListController

-(void)loadView
{
    [super loadView];
    
    _messageView = [[TMContactListView alloc] initWithFrame:CGRectZero];
...
{
    TMContactListController *nc = [[TMContactListController alloc] init];
