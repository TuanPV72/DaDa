...
@interface DDMessageDetailView()<UITableViewDataSource, UITableViewDelegate,UITextViewDelegate>
{
...
@implementation DDMessageDetailView
...
{
    self = [[[NSBundle mainBundle] loadNibNamed:@"DDMessageDetailView" owner:self options:nil] objectAtIndex:0];
    if (self) {
