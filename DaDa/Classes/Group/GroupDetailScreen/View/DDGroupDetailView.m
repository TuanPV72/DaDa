...
#import "DDGroupMessageUseCell.h"
#import "DDGroupMessageMeCell.h"
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (type == 0) {
        ...
        static NSString *deque = @"DDGroupMessageUseCell";
        DDGroupMessageUseCell *cell = (DDGroupMessageUseCell *)[tableView dequeueReusableCellWithIdentifier:deque];
        
        if (!cell) {
            cell = [[[NSBundle mainBundle] loadNibNamed:@"DDGroupMessageUseCell" owner:self options:nil] firstObject];
        }
        ...
        static NSString *deque = @"DDGroupMessageMeCell";
        DDGroupMessageMeCell *cell = (DDGroupMessageMeCell *)[tableView dequeueReusableCellWithIdentifier:deque];
        if (!cell) {
            cell = [[[NSBundle mainBundle] loadNibNamed:@"DDGroupMessageMeCell" owner:self options:nil] firstObject];
        }
